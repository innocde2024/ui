export const exploreWorlds = [
  {
    ...
    description: 'Bùng nổ của AI đã đem đến những biến đổi đáng kinh ngạc cho cuộc sống con người. Trí tuệ nhân tạo (AI) tại FPT Education được chính thức thành lập vào năm 2018',
  },
  {
    id: 'world-2',
    imgUrl: '/semiconduct.jpg',
    title: 'Bán dẫn',
    description: 'FPT Edu đánh giá việc mở Khoa Vi mạch Bán là nhu cầu cấp thiết, quan trọng trong quy hoạch trọng điểm nhân lực cho ngành công nghiệp bán dẫn Việt Nam, và toàn cầu',
  },
  // {
  //   id: 'world-3',
  ...
  // },
  {
    ...
    imgUrl: '/digital.jpg',
    title: 'Chuyển đổi số',
    description: 'Với tầm nhìn trở thành hệ thống giáo dục quốc tế Mega, đáp ứng nhu cầu xã hội, ứng dụng công nghệ đào tạo tiên tiến, xây dựng theo mô hình đại học thế hệ mới',
  },
  {
    id: 'world-5',
    imgUrl: '/envi.png',
    title: 'Môi trường xanh',
    description: 'FPT Education cam kết xây dựng và duy trì một môi trường xanh, bền vững, nhằm mang lại không gian học tập và làm việc lành mạnh cho sinh viên, giảng viên và nhân viên.',
  },
];

export const startingFeatures = [
  'Đại học FPT 11 năm liền đạt giải thưởng Sao Khuê',
  'Đại học FPT thuộc top 1000 trường đào tạo QTKD tốt nhất thế giới',
  'Đại học FPT đại diện Việt Nam có mặt trong Top 100 trường tham gia Chung kết ACM/ICPC toàn cầu',
];
